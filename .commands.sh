...
alias classes="subl headers/Problem.hh sources/Problem.cc headers/ProblemCol.hh sources/ProblemCol.cc \
...
alias sets="subl headers/ProblemCol.hh sources/ProblemCol.cc \

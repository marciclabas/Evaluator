...
alias classes="kate headers/Problem.hh sources/Problem.cc headers/ProblemCol.hh sources/ProblemCol.cc \
...
alias sets="kate headers/ProblemCol.hh sources/ProblemCol.cc \
			headers/SessionRep.hh sources/SessionRep.cc\
			headers/CourseSet.hh sources/CourseSet.cc \
			headers/UserSet.hh sources/UserSet.cc &"
alias cwo="cat cwo.txt"
alias strats="kate headers/VectorStrategy.hh sources/VectorStrategy.cc \

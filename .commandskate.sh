...
alias sets="kate headers/Problem.hh sources/Problem.cc headers/ProblemCol.hh sources/ProblemCol.cc \
...
alias strats="kate headers/VectorStrategy.hh sources/VectorStrategy.cc headers/MapStrategy.hh sources/MapStrategy.cc headers/RemovableMapStrategy.hh sources/RemovableMapStrategy.cc &"

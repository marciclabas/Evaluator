/**
@file Problem.hh
@brief File containing the specification of the Problem class and it's corresponding namespace
*/
...
/**
@brief Problem with a unique name (id) and some statistics
@invariant 	<ol>
...
*/
class Problem :
	public Readable, public Printable, public Identifiable<prb::ID>
{
	prb::ID id;
	struct {
...
std::ostream& operator<< (std::ostream &out, const Problem &printable);
